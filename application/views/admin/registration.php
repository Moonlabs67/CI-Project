      ...
      <div class="col-lg">
        <div class="p-5">
          ...
          <form class="user" method="post" action="<?= base_url('admin/registration'); ?>">
            ...
            <div class="form-group">
              <input type="text" class="form-control form-control-user" id="handphone" name="handphone" placeholder="No.HP" value="<?= set_value('handphone'); ?>">
              <?= form_error('handphone', '<small class="text-danger pl-3">', '</small>'); ?>
            </div>
            <div class="form-group">
              <input type="text" class="form-control form-control-user" id="roleid" name="roleid" placeholder="Hak Akses : Admin=1, Pengawas=2, Direktur=3" value="<?= set_value('handphone'); ?>">
              <?= form_error('handphone', '<small class="text-danger pl-3">', '</small>'); ?>
            </div>
